class Automobile {
    ...
    #contatoreAggiungiChilometri = 0; // Contatore specifico per aggiungiChilometri()
    ...
    aggiungiChilometri(km) {
        this.#incrementaContatore();
        this.#contatoreAggiungiChilometri += 1; // Incrementa il contatore specifico
        if (km > 0) {
...
console.log(`Chilometraggio iniziale: ${miaAuto.chilometraggioAttuale} km`); // 0 km

miaAuto.chilometraggioAttuale = 10000;

console.log(`Chilometraggio aggiornato: ${miaAuto.chilometraggioAttuale} km`); //10000
...
// Mostra il numero totale di chiamate a tutti i metodi
console.log(miaAuto.mostraContatoreChiamate());

// Mostra il numero di volte che è stato chiamato solo aggiungiChilometri()
console.log(miaAuto.mostraContatoreAggiungiChilometri());

console.log(miaAutoElettrica.mostraContatoreChiamate());

console.log(miaAutoElettrica.mostraContatoreAggiungiChilometri());

//mostra il chilometraggio attuale tesla
console.log(`Chilometraggio attuale della Tesla: ${miaAutoElettrica.chilometraggioAttuale} km`);
