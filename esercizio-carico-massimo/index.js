...
class Camion extends Automobile {
    ...
    // Sovrascrive descrizione() per includere caricoMassimo
    descrizione() {
...
console.log(mioCamion.descrizione()); // Mostra i dettagli del camion

mioCamion.carica(5000);
console.log(`Carico attuale: ${mioCamion.caricoAttuale} kg`);

mioCamion.carica(20000); // Questo supera il limite massimo
